...
/**
 * Api services for the `VMDUsercredential` model.
 */
@Injectable()
export class VMDUsercredentialApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id VMDUsercredential id
   *
   ...
   * This usually means the response is a `VMDUsercredential` object.)
   * </em>
   */
  public findByIdAccessTokens(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VMDUsercredentials/:id/accessTokens/:fk";
  ...
  /**
   * Queries accessTokens of VMDUsercredential.
   *
   * @param {any} id VMDUsercredential id
   *
   * @param {object} filter 
  ...
  public getAccessTokens(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VMDUsercredentials/:id/accessTokens";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts accessTokens of VMDUsercredential.
   *
   * @param {any} id VMDUsercredential id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VMDUsercredentials/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public changePassword(oldPassword: any, newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VMDUsercredentials/change-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
  ...
  public setPassword(newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VMDUsercredentials/reset-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        newPassword: newPassword
  ...
  /**
   * @ngdoc method
   * @name sdk.VMDUsercredential#getCurrent
   * @methodOf sdk.VMDUsercredential
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/VMDUsercredentials" + "/:id";
   ...
   * call to {@link sdk.VMDUsercredential#login} or
   * {@link sdk.VMDUsercredential#getCurrent}. Return null when there
   ...
   * call to {@link sdk.VMDUsercredential#login}
   *
  ...
  /**
   * @name sdk.VMDUsercredential#isAuthenticated
   *
  ...
  /**
   * @name sdk.VMDUsercredential#getCurrentId
   *
